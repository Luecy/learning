;(() => {
	...
	const methodNames = new Map([
		["self", ["defineProperty", "freezeProperty", "$", "sleep", "downloadFile", "canvasToURL", "drawImagefileToCanvas"]],
		["Math", ["randomInt"]],
	...
	const defineProperty = (property, value, object = "self", writable = false) => {
	...
	const methods = [
		...
		//self.downloadFile
		(file, fileName = "00.txt", anchor = document.querySelector("a")) => {
